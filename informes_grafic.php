        ...
        <div class="container mt-4 main-container">
            <div class="card mb-4">
				<form>
					<div class="card-header border-bottom">
						<h5 class="content-color-primary mb-0">INFORMES GRAFICOS</h5>
					</div>
					<div class="card-body">
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="content-color-primary mb-0">INFORME GRAFICO <small>BARRAS </small></h5>
                        </div>
                        <div class="card-body">
			...
			<div class="row">
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="card mb-3">
                        <div class="card-header">
                            <h5 class="content-color-primary mb-0">INFORME GRAFICO <small>DONA </small></h5>
                        </div>
                        <div class="card-body text-center">
                            <h2 class="font-weight-light">DATOS</h2>
                            <p class="content-color-secondary">Total Datos</p>
                            <br>
                            <canvas id="donutchart-area" class="text-primary"></canvas>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="card mb-3">
                        <div class="card-header">
                            <h5 class="content-color-primary mb-0">INFORME GRAFICO <small>PIE </small></h5>
                        </div>
                        <div class="card-body text-center">
                            <h2 class="font-weight-light">DATOS</h2>
                            <p class="content-color-secondary">Total Datos</p>
                            <br>
                            <br>
                            <canvas id="pie-area" class="text-primary"></canvas>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="card mb-3">
                        <div class="card-header">
                            <h5 class="content-color-primary mb-0">INFORME GRAFICO <small>POLAR </small></h5>
                        </div>
                        <div class="card-body  text-center">
                            <h2 class="font-weight-light">DATOS</h2>
                            <p class="content-color-secondary">Total Datos</p>
                            <br>
                            <br>
                            <canvas id="polar-area" class="text-primary"></canvas>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="card mb-3">
                        <div class="card-header">
                            <h5 class="content-color-primary mb-0">Radar <small>Chart js Chart </small></h5>
                        </div>
                        <div class="card-body">
                            <br>
                            <canvas id="radar-area" class="text-primary mb-2"></canvas>
                        </div>
