        ...
        <div class="container mt-4 main-container">
			...
			<form>
                <div class="card-header border-bottom">
                    <h5 class="content-color-primary mb-0">ADMINISTRACION DE PARQUEADERO</h5>
                </div>
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-md-10 mx-auto">
                            <h5 class="m-0">ADMINISTRACION DE PARQUEADERO</h5>
                            <hr>
								...
								<div class="col-md-12">
                                    ...
                                    <div class="custom-dropzone text-center align-items-center" id="my-dropzone">
                                        <div class="dz-default dz-message" data-dz-message="">
                                            ...
                                            <p>Suelte aquí o haga clic aquí para subir</p>
                                        </div>
                                    </div>
                        ...
                        <div class="card-header">
                            <div class="media">
                                <div class="media-body">
                                    <h4 class="content-color-primary mb-0">REGISTRO DE PARQUEADEROS</h4>
                                </div>
