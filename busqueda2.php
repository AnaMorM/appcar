    ...
    <div class="wrapper">
        ...
        <div class="container mt-4 main-container">
            ...
            <div class="card-body">
                <table class="table ">
                    ...
                    <tbody> 
                        ...
                        <tr class="odd">
                            <td>valor por mensual</td>
                            <td>$$$$</td>
                        </tr>
                        <tr class="odd">
                            <td>valor por bimensual</td>
                            <td>$$$$</td>
                        </tr>
                        <tr class="odd">
                            <td>valor por anual</td>
                            <td>$$$$</td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="card-footer">
                <a href="calendario.php" class="btn btn-success float-right">comprobar disponibilidad</a>
            </div>
