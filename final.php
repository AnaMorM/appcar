...
<body class="fixed-header sidebar-right-close">
    ...
    <div class="wrapper">
        ...
        <div class="container mt-4 main-container">
            ...
            <div class="col-md-11">
                <label>transaccion terminada</label>
                <label>comunicate con el dueño de el garaje</label>
                
                <div class="card-footer">
                    <a href="mensaje2.php" class="btn btn-success float-right">enviar mensaje</a>
