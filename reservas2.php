    ...
    <div class="wrapper">
            ...
            <div class="card mb-4">
				<form>
					<div class="card-header border-bottom">
						<h5 class="content-color-primary mb-0">SOLICITUD DE RESERVAS</h5>
					</div>
				</form>
            </div>
        </div>
        ...
        <div class="container mt-4 main-container">
            <div class="card mb-4">
                <form>
                    <div class="card-header border-bottom">
                        <h1 class="content-color-primary mb-0">PEDRITO PEREZ</h1>
                    </div>
                </form>
                <div class="card-body">
                <table class="table ">
            ...
            <div class="card-footer">
                <a href="calendario2.php" class="btn btn-success float-right">ver en calendario</a>
            </div>
            <div class="card-footer">
                <a href="reservas.php" class="btn btn-success float-right">Aceptar</a>
            </div>
            <div class="card-footer">
                <a href="reservas2.php" class="btn btn-successss btn-success float-right">rechazar</a>
            </div>
            ...
            </div><div class="container mt-4 main-container">
            <div class="card mb-4">
                <form>
                    <div class="card-header border-bottom">
                        <h1 class="content-color-primary mb-0">PEDRITO PEREZ</h1>
...
<!-- page specific script -->
    ...
    <script>
        ...
        $("#success").on('click', function() {
            $.toast({
                heading: 'Success',
                text: 'EL ARCHIVO SE HA GENERADO EXITOSAMENTE, SE ESTA DESCARGANDO',
                showHideTransition: 'slide',
				position: 'top-center',
                icon: 'success'
            })
        });
        $("#positionbottom-left").on('click', function() {
        ...
        $("#positionbottom-center").on('click', function() {
            $('.jq-toast-wrap').remove();
            $.toast({
                heading: 'Error',
                text: 'Report any <a href="https://github.com/kamranahmedse/jquery-toast-plugin/issues">issues</a>',
        ...
        $("#positionbottom-right").on('click', function() {
            $('.jq-toast-wrap').remove();
            $.toast({
                heading: 'Warning',
                text: 'It is going to be supper easy for you to use ;)',
        ...
        $("#positiontop-left").on('click', function() {
            $('.jq-toast-wrap').remove();
            $.toast({
                heading: 'Information',
                text: 'Now you can add icons to generate different kinds of toasts',
        ...
        $("#positiontop-center").on('click', function() {
            $('.jq-toast-wrap').remove();
            $.toast({
                heading: 'Error',
                text: 'Report any <a href="https://github.com/kamranahmedse/jquery-toast-plugin/issues">issues</a>',
        ...
        $("#positiontop-right").on('click', function() {
            $('.jq-toast-wrap').remove();
            $.toast({
                heading: 'Warning',
                text: 'It is going to be supper easy for you to use ;)',
        ...
        $("#positionmid-center").on('click', function() {
            $('.jq-toast-wrap').remove();
            $.toast({
                heading: 'Positioning',
