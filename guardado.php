    ...
    <div class="wrapper">
        ...
        <div class="container mt-4 main-container">
            ...
            <figure class="avatar avatar-120">
                <a href="guarda2.php"><img src="img/img-turismo-Centro-Vacaiones-Cafam-Melgar-personas.jpg" alt=""></a>
            </figure> 

            <figure class="avatar avatar-120">
                <img src="img/img-turismo-Centro-Vacaiones-Cafam-Melgar-personas.jpg" alt="">
            </figure> 
            ...
            <figure>
                <label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbspMELGAR</label>

            </figure>

            <figure>
                <label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspCUCUTA</label>
            </figure>
