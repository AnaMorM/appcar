    ...
    <div class="wrapper">
        ...
        <div class="container mt-4 main-container">
            ...
            <div class="col-md-11">
                ...
                <input type="text" class="form-control" placeholder="LUGAR x">
                <div class="card-footer">
                    <a href="busqueda.php" class="btn btn-success float-right">buscar</a>
        ...
        <div class="form-group row">
            ...
            <figure class="avatar avatar-120">
                <a href="busqueda2.php"><img src="img/415983_204057_1.jpg" alt="busqueda2.php"></a>
            </figure> 
            <img src="img/22236.png" alt="" style="width:3%;height: 3%;">
            <figure class="avatar avatar-120">
                <img src="img/415983_204057_1.jpg" alt="">
            </figure>
            <img src="img/22236.png" alt="" style="width:3%;height: 3%;">
            <figure class="avatar avatar-120">
                <img src="img/415983_204057_1.jpg" alt="">
            </figure>
            <a href="guardado.php"><img src="img/22236.png" alt="" style="height: 5%;"></a>

        </div>
        <div class="form-group row">

            <figure>
                <label>PARQUEADERO X</label>
        ...
        <!-- content page ends 415983_204057_1-->
