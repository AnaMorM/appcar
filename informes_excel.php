		...
		<div class="card">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a href="informes_grafic.php" class="nav-link pink-gradient-active"><i class="material-icons icon"></i> <span>reservas</span></a>
                            <a href="informes_excel.php" class="nav-link pink-gradient-active"><i class="material-icons icon"></i> <span>reservas</span></a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
            ...
            <div class="card mb-4">
				<form>
					<div class="card-header border-bottom">
						<h5 class="content-color-primary mb-0">INFORMES EXCEL</h5>
					</div>
					<div class="card-body">
					...
					<div class="card-footer">
                        ...
                        <a href="informes_excel1.php" class="btn btn-success float-right">Exportar</a>
